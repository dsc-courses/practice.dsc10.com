...
For a 95% CLT interval for a proportion, the width is approximately $4\sqrt{p(1-p)/n}$. This is largest when $p = 0.5$, giving width $\approx 2/\sqrt{n}$. Setting $2/\sqrt{n} \le 0.1$ gives $n \ge 400$.
