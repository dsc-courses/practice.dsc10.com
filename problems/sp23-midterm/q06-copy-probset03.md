...
As we said at the start of the last solution, the key property of histograms is that the proportion of values in a bin is equal to the area of the corresponding bar. Then, the number of students represented by a bar is the total number of students in DSC 10 (200) multiplied by the area of the bar.
