...
The main idea is to create a function that first calculates the ISBN check digit by alternating between adding digits directly (even indices) and multiplying by 3 (odd indices), summing the results. Which we then take the last digit
