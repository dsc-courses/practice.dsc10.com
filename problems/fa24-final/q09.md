...
Since the the **combined curve** is a combination of two normal distributions, we can approximate the total area by averaging the areas under the individual cash and non-cash curves between $\$14$ and $\$22$.

1. For cash:
   - P(Z ≤ (22-14)/2) - P(Z ≤ (14-14)/2)
   - P(Z ≤ 4) - P(Z ≤ 0) = scipy.stats.norm.cdf(4) - scipy.stats.norm.cdf(0)

2. Non-cash:
   - P(Z ≤ (22-22)/4) - P(Z ≤ (14-22)/4)
   - P(Z ≤ 0) - P(Z ≤ -2) = scipy.stats.norm.cdf(0) - scipy.stats.norm.cdf(-2)

Averaging area under the two distributions:
(scipy.stats.norm.cdf(4) - scipy.stats.norm.cdf(0) + scipy.stats.norm.cdf(0) - scipy.stats.norm.cdf(-2)) / 2 = **scipy.stats.norm.cdf(4) - scipy.stats.norm.cdf(-2) / 2**
