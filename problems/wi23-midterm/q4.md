...
**Option 3:** This is incorrect because there can be more than `n` rows. It is possible that a storm appears multiple times. For example the storm `Anna` occurred three different times on August 21, 1965 without sorting.
